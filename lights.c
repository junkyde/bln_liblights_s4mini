        ...
        struct light_state_t const* state)
{
    ...
    ALOGV("set_light_notifications g_trackball=%d color=0x%08x %s flashMode=%d flashOnMS=%d flashOffMS=%d\n",
            g_trackball, state->color, __func__,
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    .name = "s4 mini custom lights module with bln support",
    .author = "junkyde",
